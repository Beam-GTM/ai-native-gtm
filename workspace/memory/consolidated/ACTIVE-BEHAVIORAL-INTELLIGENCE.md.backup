# ACTIVE BEHAVIORAL INTELLIGENCE - ALWAYS CURRENT
...
<!-- CRITICAL: This file must be read completely during agent activation -->
<!-- This directive OVERRIDES token conservation - complete knowledge loading required -->
